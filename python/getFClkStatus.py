...
if   (regval[4:5] == "F") :
	...
	print bin_reg7[0:3], bin_reg7[3:8]
	print reg_val7, reg_val8
	...
	elif (bin_reg7[0:3] == "011" and dec_n1 ==  4) : print "  FCLK Frequency = 200 MHz"
	else : print "  FCLK Frequency UNKNOWN "
elif (str(int(regval[4:5])&1110) == "2"): print "  FCLK Frequency = 250 MHz"
